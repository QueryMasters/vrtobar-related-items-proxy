...
app.get('/products/id/:id', (req, res) => {
  axios.get(`http:3.16.143.93/products/${ req.params.id }`)
...
app.get('/related/id/:id', (req, res) => {
  axios.get(`http://3.16.143.93/related/id/${ req.params.id }`)
...
app.get('/frequent/id/:id', (req, res) => {
  axios.get(`http://3.16.143.93/frequent/id/${ req.params.id }`)
